					...
					<div class="box-body">
						...
						<div class="row">
							...
							<div class="col-md-4 {{ form_error('provider_rate_initialVisit') ? 'has-error' : '' }}">
								<label class="control-label">Initial Visit (Face to Face) <span>*</span></label>
								<input type="text" class="form-control" name="provider_rate_initialVisit" required="true" value="{{ set_value('provider_rate_initialVisit', record.provider_rate_initialVisit) }}">
							</div>

							<div class="col-md-4 {{ form_error('provider_rate_initialVisit_TeleHealth') ? 'has-error' : '' }}">
							...
							<div class="col-md-4 {{ form_error('provider_rate_followUpVisit') ? 'has-error' : '' }}">
								<label class="control-label">Follow-up Visit (Face to Face) <span>*</span></label>
								<input type="text" class="form-control" name="provider_rate_followUpVisit" required="true" value="{{ set_value('provider_rate_followUpVisit', record.provider_rate_followUpVisit) }}">
							</div>

							<div class="col-md-4 {{ form_error('provider_rate_followUpVisit_TeleHealth') ? 'has-error' : '' }}">
							...
							<div class="col-md-4 {{ form_error('provider_rate_hospiceEvaluationVisit') ? 'has-error' : '' }}">
								<label class="control-label">Hospice Evaluation Visit (Face to Face) <span>*</span></label>
								<input type="text" class="form-control" name="provider_rate_hospiceEvaluationVisit" required="true" value="{{ set_value('provider_rate_hospiceEvaluationVisit', record.provider_rate_hospiceEvaluationVisit) }}">
							</div>

							<div class="col-md-4 {{ form_error('provider_rate_hospiceEvaluationVisit_TeleHealth') ? 'has-error' : '' }}">
								<label class="control-label">Hospice Evaluation Visit (Telehealth)</label>
								<input type="text" class="form-control" name="provider_rate_hospiceEvaluationVisit_TeleHealth" value="{{ set_value('provider_rate_hospiceEvaluationVisit_TeleHealth', record.provider_rate_hospiceEvaluationVisit_TeleHealth) }}">
							</div>



							<div class="col-md-4 {{ form_error('provider_rate_hospiceFollowUpVisit') ? 'has-error' : '' }}">
								<label class="control-label">Hospice Follow-up Visit (Face to Face) <span>*</span></label>
								<input type="text" class="form-control" name="provider_rate_hospiceFollowUpVisit" required="true" value="{{ set_value('provider_rate_hospiceFollowUpVisit', record.provider_rate_hospiceFollowUpVisit) }}">
							</div>

							<div class="col-md-4 {{ form_error('provider_rate_hospiceFollowUpVisit_TeleHealth') ? 'has-error' : '' }}">
								<label class="control-label">Hospice Follow-up Visit (Telehealth)</label>
								<input type="text" class="form-control" name="provider_rate_hospiceFollowUpVisit_TeleHealth" value="{{ set_value('provider_rate_hospiceFollowUpVisit_TeleHealth', record.provider_rate_hospiceFollowUpVisit_TeleHealth) }}">
							</div>


							<div class="col-md-4 {{ form_error('provider_rate_changeOfConditionVisit') ? 'has-error' : '' }}">
								<label class="control-label">Change of Condition Visit (Face to Face) <span>*</span></label>
								<input type="text" class="form-control" name="provider_rate_changeOfConditionVisit" required="true" value="{{ set_value('provider_rate_changeOfConditionVisit', record.provider_rate_changeOfConditionVisit) }}">
							</div>

							<div class="col-md-4 {{ form_error('provider_rate_changeOfConditionVisit_TeleHealth') ? 'has-error' : '' }}">
								<label class="control-label">Change of Condition Visit (Telehealth)</label>
								<input type="text" class="form-control" name="provider_rate_changeOfConditionVisit_TeleHealth" value="{{ set_value('provider_rate_changeOfConditionVisit_TeleHealth', record.provider_rate_changeOfConditionVisit_TeleHealth) }}">
							</div>



							<div class="col-md-4 {{ form_error('provider_rate_transitionalCareVisit') ? 'has-error' : '' }}">
								<label class="control-label">Transitional Care Visit (Face to Face) <span>*</span></label>
								<input type="text" class="form-control" name="provider_rate_transitionalCareVisit" required="true" value="{{ set_value('provider_rate_transitionalCareVisit', record.provider_rate_transitionalCareVisit) }}">
							</div>


							<div class="col-md-4 has-error" style="height: 60px;">
							...
							<div class="col-md-4 {{ form_error('provider_rate_aw') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_aw" required="true" value="{{ set_value('provider_rate_aw', record.provider_rate_aw) }}">
							</div>

							<div class="col-md-4 {{ form_error('provider_rate_acp') ? 'has-error' : '' }}">
								<label class="control-label">ACP <span>*</span></label>
								<input type="text" class="form-control" name="provider_rate_acp" required="true" value="{{ set_value('provider_rate_acp', record.provider_rate_acp) }}">
							</div>

							<div class="col-md-4 {{ form_error('provider_rate_noShowPT') ? 'has-error' : '' }}">
								<label class="control-label">No Show <span>*</span></label>
								<input type="text" class="form-control" name="provider_rate_noShowPT" required="true" value="{{ set_value('provider_rate_noShowPT', record.provider_rate_noShowPT) }}">
							</div>
							...
							<div class="col-md-4 {{ form_error('provider_rate_mileage') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_mileage" required="true" value="{{ set_value('provider_rate_mileage', record.provider_rate_mileage) }}">


							</div>

							<div class="col-md-4 {{ form_error('provider_rate_ca_homeHealth') ? 'has-error' : '' }}">
									
									<label class="control-label">Cognitive Assessment HomeHealth <span>*</span></label>

									<input type="text" class="form-control" name="provider_rate_ca_homeHealth" required="true"  value="{{ set_value('provider_rate_ca_homeHealth', record.provider_rate_ca_homeHealth) }}">

									
									</div>

									<div class="col-md-4 {{ form_error('provider_rate_ca_teleHealth') ? 'has-error' : '' }}">
									
									<label class="control-label">Cognitive Assessment TeleHealth <span>*</span></label>

									<input type="text" class="form-control" name="provider_rate_ca_teleHealth"  required="true"  value="{{ set_value('provider_rate_ca_teleHealth', record.provider_rate_ca_teleHealth) }}">
