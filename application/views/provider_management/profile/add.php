					...
					<div class="box-body">
						...
						<div class="row">
							...
							<div class="col-md-4 {{ form_error('provider_rate_hospiceEvaluationVisit') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_hospiceEvaluationVisit" required="true" value="{{ set_value('provider_rate_hospiceEvaluationVisit') }}">
							</div>
							...
							<div class="col-md-4 {{ form_error('provider_rate_hospiceEvaluationVisit_TeleHealth') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_hospiceEvaluationVisit_TeleHealth" value="{{ set_value('provider_rate_hospiceEvaluationVisit_TeleHealth') }}">
							</div>
							...
							<div class="col-md-4 {{ form_error('provider_rate_hospiceFollowUpVisit') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_hospiceFollowUpVisit" required="true" value="{{ set_value('provider_rate_hospiceFollowUpVisit') }}">
							</div>
							...
							<div class="col-md-4 {{ form_error('provider_rate_hospiceFollowUpVisit_TeleHealth') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_hospiceFollowUpVisit_TeleHealth" value="{{ set_value('provider_rate_hospiceFollowUpVisit_TeleHealth') }}">
							</div>
							...
							<div class="col-md-4 {{ form_error('provider_rate_changeOfConditionVisit') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_changeOfConditionVisit" required="true" value="{{ set_value('provider_rate_changeOfConditionVisit') }}">
							</div>
							...
							<div class="col-md-4 {{ form_error('provider_rate_changeOfConditionVisit_TeleHealth') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_changeOfConditionVisit_TeleHealth" value="{{ set_value('provider_rate_changeOfConditionVisit_TeleHealth') }}">
							</div>
							...
							<div class="col-md-4 {{ form_error('provider_rate_transitionalCareVisit') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="provider_rate_transitionalCareVisit" required="true" value="{{ set_value('provider_rate_transitionalCareVisit') }}">
							</div>
							...
							<div class="col-md-4 {{ form_error('provider_rate_ca_homeHealth') ? 'has-error' : '' }}">
										...
										<input type="text" class="form-control" name="provider_rate_ca_homeHealth" required="true" value="{{ set_value('provider_rate_ca_homeHealth') }}">
								...
								<div class="col-md-4 {{ form_error('provider_rate_ca_homeHealth') ? 'has-error' : '' }}">
									...
									<input type="text" class="form-control" name="provider_rate_ca_teleHealth" required="true" value="{{ set_value('provider_rate_ca_teleHealth') }}">
