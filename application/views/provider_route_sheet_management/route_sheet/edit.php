								...
								<div class="row">
									<div class="patient-details-container">
										...
										{% for index, list in lists %}								
											...
											<div class="patient-details-item ui-state-default pull-left" style="border:none;" {{ index > 0 ? "data-item-num=#{ index + 1 }" }}>
												...
												<select class="form-control" required="true" name="pt_reasonForVisit[]">
													<option value="">Select</option>
														...
														<option value="Office Request Visit (Meds / Labs)" {{ list.pt_reasonForVisit == 'Office Request Visit (Meds / Labs)' ? 'selected=true' : '' }}>Office Request Visit (Meds / Labs)</option>
												</select>
											</div>
											...
											<div class="col-md-12 has-error">
													<span class="help-block">{{ form_error('pt_reasonForVisit') }}</span>
												</div>
