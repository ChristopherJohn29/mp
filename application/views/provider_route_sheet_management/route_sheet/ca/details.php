        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
                ...
                <input type="hidden" value="1" name="is_ca">
                        ...
                        <div class="row spacer-bottom">
                 		...
                 		<div class="row">
                 			<div class="col-md-12">
                 				...
                 				<p class="lead">Cognitive Visit Route Sheet</p>
    								...
    								<tbody>
    									...
    									{% for list in lists %}
    										...
    										<tr>
    											...
    											<td><p>Reason for Visit : {{ list.pt_reasonForVisit }}</p>
    					...
    					<div class="row no-print">
        					...
        					<div class="col-xs-12 xrx-btn-handler">
                                ...
                                {% if roles_permission_entity.has_permission_name(['print_prs']) %}
                                  ...
                                  <a href="{{ site_url("provider_route_sheet_management/route_sheet/print/#{ record.prs_id }/ca") }}" target="_blank" class="btn btn-primary xrx-btn"><i class="fa fa-print"></i> Print</a>
