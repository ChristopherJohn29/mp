                                    ...
                                    <div class="tab-pane {{ index < 1 ? 'active' : '' }}" id="tab_{{ index }}">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="{{ site_url("ajax/patient_management/transaction/mark_service_paid/#{ transaction.pt_patientID }/#{ transaction.pt_id }") }}" data-paid-btn>
                                                <button type="button" class="btn btn-danger btn-sm bg-btn-red">
                                ...
                                <table class="table no-margin table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="180px">Order by</th>
                                            <th width="100px">Status</th>
                                            <th>Note</th>
                                            <th width="115px">Added by</th>
                                            <th width="200px">Download File</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                {% if lab_order.lab_order_file %}
                                                {% set datas = lab_order.lab_order_file|split(',') %}
                                                {% for data in datas|slice(0, 5) %}

                                                <a style="    display: block;" href="../../../uploads/{{ data|replace({'"': ''})|replace({'[': ''})|replace({']': ''}) }}" download>{{ data|replace({'"': ''})|replace({'[': ''})|replace({']': ''}) }}</a>
                                ...
                                <table class="table no-margin table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            {% if cpo.cpo_file %}
                                                <a href="../../../uploads/{{cpo.cpo_file}}" download>{{ cpo.ptcpo_period }}</a>
                                                {% else %}
                                                {{ cpo.ptcpo_period }}
                                            {% endif %}
                                            </td>
                                            ...
                                            {% if cpo.cpo_file_cert %}
                                                <a href="../../../uploads/{{cpo.cpo_file_cert}}" download>{{ cpo.ptcpo_dischargeDate }}</a>
                                                {% else %}
                                                {{ cpo.ptcpo_dischargeDate }}
                                            {% endif %}
